/**
 * VocalEstadisticasActividadesPage - Página de estadísticas de actividades para vocales
 * 
...
const VocalEstadisticasActividadesPage: React.FC = () => {
  ...
  return (
    <DashboardLayout title="Estadísticas de Actividades - Vocal">
          ...
          <HStack justify="space-between" align="center" mb={4}>
            <HStack>
              ...
              <Heading size="lg" color="purple.500">
                Estadísticas de Actividades - Vocal
              </Heading>
            </HStack>
            <Button
...
export default VocalEstadisticasActividadesPage;
